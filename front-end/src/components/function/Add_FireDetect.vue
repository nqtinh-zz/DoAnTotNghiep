<template>
  <div>
    ...
    <div v-else>trang su dung function</div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    add_function: function () {
      ...
      this.$store.dispatch('add_function_to_project', data).then(resp => {
