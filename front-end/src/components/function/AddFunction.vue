  ...
  <div v-else-if="function_id !== 1">
    ...
    <v-flex mt-3 ml-4 mb-1>
      <v-flex class="ml-0 pl-4" style="font-size: 16px">
         Bạn muốn thêm Functiondsfaaaaaaaaa <b>F.Smart Door</b> vào Project <b>{{nameProject}}</b>
         Bạn muốn thêm Function<b>F.Smart Door</b> vào Project <b>{{nameProject}}</b>
      </v-flex>
      <v-flex class="ml-0 pl-4">
        ...
        <v-btn >
          trial 30 days free sdfsdfsdfsdfdsfsdaf
